...
class InsFinancialReport(models.TransientModel):
            ...
            if report.type == 'accounts':
                ...
                if self.account_report_id != \
                    ...
                    if report == self.env.ref('account_dynamic_reports.ins_account_financial_report_cash_flow0'):
                        accounts = self.env['account.account'].search([('company_id', '=', self.company_id),
    ...
    def get_report_values(self):
        ...
        used_context['company_id'] = self.company_id.id
        ...
        comparison_context['company_id'] = self.company_id.id
    ...
    def _get_default_date_range(self):
        return self.company_id.date_range

    @api.model
    def _get_default_financial_year(self):
        return self.company_id.financial_year
